 ...
 * @param {string} version - Version string like "0.1.7-OS10"
 * @returns {number} - The versionCode (10)
 */
 ...
 * @returns {string} - Next version like "0.1.7-OS11"
 */
...
async function getCommitsSinceLastTag() {
  try {
    ...
    // Example: 0.1.7-OS10, 0.1.7-OS11, etc.
