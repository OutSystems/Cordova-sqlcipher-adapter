...
- SQLCipher version information:
  - SQLCipher `4.4.2` community for Android - in custom build from <https://github.com/brodybits/android-database-sqlcipher/tree/v4.3.x-defensive-jar-build> (`v4.3.x-defensive-jar-build` branch)
  - SQLCipher `4.4.2` community for iOS/macOS
